...
package com.jack.imageloader.cache;
...
public class DiskLruCache {
   ...
   * {@link com.jack.imageloader.cache.DiskLruCache#openCache(android.content.Context, java.io.File, long)} which runs some extra
  ...
  public void putFromFetcher(String url) {
   ...
   * called directly, call {@link com.jack.imageloader.cache.DiskLruCache#clearCache(android.content.Context, String)} or
   * {@link com.jack.imageloader.cache.DiskLruCache#clearCache()} instead.
   * 
   * @param cacheDir
   ...
   * {@link com.jack.imageloader.cache.DiskLruCache#setCompressParams(android.graphics.Bitmap.CompressFormat, int)} first to set
